...
Dim buffer As clsBuffer
   ...
   On Error GoTo errorhandler
    ...
    buffer.WriteString txtRUsuario
    buffer.WriteString txtREmail
    buffer.WriteString txtRSenha
    buffer.WriteString txtRSenha2
    buffer.WriteString ValorCaptcha
    buffer.WriteString txtRCaptcha
...
Dim buffer As clsBuffer
   ...
   On Error GoTo errorhandler
    ...
    buffer.WriteString txtLUsuario
    buffer.WriteString txtLSenha
...
Dim buffer As clsBuffer, i As Long, z As Long
   ...
   On Error GoTo errorhandler
    ...
    buffer.WriteString txtUsername
    buffer.WriteLong NewCharSex
    buffer.WriteLong newCharClass
