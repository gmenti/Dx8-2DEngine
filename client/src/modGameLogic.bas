   ...
   On Error GoTo errorhandler
    ...
    Do While InGame
        ...
        End If
            ...
            If FadeType <> 2 Then
                If FadeType = 1 Then
                    If Not FadeAmount = 255 Then
                        FadeAmount = FadeAmount + 50
                    End If
                ElseIf FadeType = 0 Then
                    If Not FadeAmount = 0 Then
...
Dim aux As Long
   ...
   On Error GoTo errorhandler
    ...
    If Options.FullScreen = 1 Then
        ...
        UpdateDebugCaption
    End If
    frmMain.Width = PixelsToTwips(CInt(MenuWidth) + GetTitleWidth)
    frmMain.Height = PixelsToTwips(CInt(MenuHeight) + GetTitleHeight)
    ...
    ' Shutdown the game
    menuPreto = True
    menuPretoMensagem = "Fechando o jogo..."
    Call DestroyGame
