...
Public Sub CheckInputKeys()
   ...
   On Error GoTo errorhandler
    ...
    If chatOn = False Then
        ...
        If GetKeyState(vbKeyControl) < 0 Or (GetKeyState(vbKeyRButton) < 0 And Options.ClicktoWalk = 1) Then
            SpaceDown = True
        End If
        
        If GetKeyState(vbKeySpace) < 0 Or (GetKeyState(vbKeyRButton) < 0 And Options.ClicktoWalk = 1) Then
            CheckMapGetItem
        End If
...
Dim isHandled As Boolean
   ...
   On Error GoTo errorhandler
    ...
    'Voltar Button
    If isHandled = False Then
        If X >= NCVoltarButtonBounds.Left And X <= NCVoltarButtonBounds.Left + NCVoltarButtonBounds.Right Then
            If Y >= NCVoltarButtonBounds.Top And Y <= NCVoltarButtonBounds.Top + NCVoltarButtonBounds.Bottom Then
                NCVoltarButtonState = 2
            End If
        End If
    End If
...
Dim isHandled As Boolean
   ...
   On Error GoTo errorhandler
    ...
    If Not CharSelection(SelectedChar).Level = "" Then
        'jogar
        If isHandled = False Then
...
Dim isHandled As Boolean
   ...
   On Error GoTo errorhandler
    ...
    'Captcha
    If isHandled = False Then
        If X >= CaptchaBounds.Left And X <= CaptchaBounds.Left + CaptchaBounds.Right Then
            If Y >= CaptchaBounds.Top And Y <= CaptchaBounds.Top + CaptchaBounds.Bottom Then
                SelTextbox = 4
                isHandled = True
            End If
        End If
    ...
    'Email
    If isHandled = False Then
        If X >= REmailBounds.Left And X <= REmailBounds.Left + REmailBounds.Right Then
            If Y >= REmailBounds.Top And Y <= REmailBounds.Top + REmailBounds.Bottom Then
                SelTextbox = 5
                isHandled = True
            End If
        End If
    ...
    'Voltar Button
    If isHandled = False Then
        If X >= RVoltarButtonBounds.Left And X <= RVoltarButtonBounds.Left + RVoltarButtonBounds.Right Then
            If Y >= RVoltarButtonBounds.Top And Y <= RVoltarButtonBounds.Top + RVoltarButtonBounds.Bottom Then
                RVoltarButtonState = 2
            End If
        End If
    End If
        ...
        Case 1
            ...
            If X >= LoginPanelBounds.Left And X <= LoginPanelBounds.Left + LoginPanelBounds.Right Then
                If Y >= LoginPanelBounds.Top And Y <= LoginPanelBounds.Top + LoginPanelBounds.Bottom Then
                    isHandled = HandleLoginPanel_MouseDown(X, Y)
                End If
            End If
        Case 2
            'Register
   ...
   On Error GoTo errorhandler
            ...
            If SelTextbox = 1 Then
                If KeyAscii = vbKeyBack Then
                    If Len(txtLUsuario) > 0 Then
                        txtLUsuario = Left(txtLUsuario, Len(txtLUsuario) - 1)
                    End If
                Else
                    txtLUsuario = txtLUsuario & Chr(KeyAscii)
                End If
            ElseIf SelTextbox = 2 Then
                If KeyAscii = vbKeyBack Then
                    If Len(txtLSenha) > 0 Then
                        txtLSenha = Left(txtLSenha, Len(txtLSenha) - 1)
                    End If
                Else
                    txtLSenha = txtLSenha & Chr(KeyAscii)
                End If
            End If
        End If
    ElseIf MenuStage = 2 Then
        ...
        Else
            If SelTextbox = 1 Then
                If KeyAscii = vbKeyBack Then
                    If Len(txtRUsuario) > 0 Then
                        txtRUsuario = Left(txtRUsuario, Len(txtRUsuario) - 1)
                    End If
                Else
                    txtRUsuario = txtRUsuario & Chr(KeyAscii)
                End If
            ElseIf SelTextbox = 2 Then
                If KeyAscii = vbKeyBack Then
                    If Len(txtRSenha) > 0 Then
                        txtRSenha = Left(txtRSenha, Len(txtRSenha) - 1)
                    End If
                Else
                    txtRSenha = txtRSenha & Chr(KeyAscii)
                End If
            ElseIf SelTextbox = 3 Then
                If KeyAscii = vbKeyBack Then
                    If Len(txtRSenha2) > 0 Then
                        txtRSenha2 = Left(txtRSenha2, Len(txtRSenha2) - 1)
                    End If
                Else
                    txtRSenha2 = txtRSenha2 & Chr(KeyAscii)
                End If
            ElseIf SelTextbox = 4 Then
                If KeyAscii = vbKeyBack Then
                    If Len(txtRCaptcha) > 0 Then
                        txtRCaptcha = Left(txtRCaptcha, Len(txtRCaptcha) - 1)
                    End If
                Else
                    If Len(txtRCaptcha) <= 3 Then
                        txtRCaptcha = txtRCaptcha & Chr(KeyAscii)
                    End If
                End If
            ElseIf SelTextbox = 5 Then
                If KeyAscii = vbKeyBack Then
                    If Len(txtREmail) > 0 Then
                        txtREmail = Left(txtREmail, Len(txtREmail) - 1)
                    End If
                Else
                    txtREmail = txtREmail & Chr(KeyAscii)
                End If
            End If
        End If
