...
Sub SendCharactersToPlayer(ByVal Index As Long)
Dim Buffer As clsBuffer
Dim i, x As Long
    ...
    For i = 1 To MAX_PLAYER_CHARS
        If Trim$(Player(Index).characters(i).Name) = "" Then
            Buffer.WriteString ""
            Buffer.WriteString ""
            Buffer.WriteString ""
            Buffer.WriteLong 0
        Else
            ...
            Buffer.WriteString Trim$(Player(Index).characters(i).Level)
        ...
        For x = 1 To Equipment.Equipment_Count - 1
            If Player(Index).characters(i).Equipment(x) > 0 Then
                Buffer.WriteLong Item(Player(Index).characters(i).Equipment(x)).Paperdoll
            Else
                Buffer.WriteLong 0
            End If
        Next
