...
Sub ClearPlayer(ByVal Index As Long)
   ...
   On Error GoTo errorhandler
    ...
    If frmEditPlayer.Visible Then
        If EditingPlayer = Index Then
            EditingPlayer = 0
            frmEditPlayer.fraEditPlayer.Visible = False
            frmEditPlayer.lblNotifications.Caption = "Player Editing Canceled! - Reason: Player Disconnected."
            frmEditPlayer.lblNotifications.ForeColor = &HFF&
        End If
    End If
...
Sub LoadClasses()
   ...
   On Error GoTo errorhandler
    ...
    For i = 1 To Max_Classes
        ...
        frmEditPlayer.cmbClass.AddItem (Trim$(Class(i).Name))
...
Sub LoadItems()
   ...
   On Error GoTo errorhandler
    ...
    frmEditPlayer.cmbWeapon.Clear
    frmEditPlayer.cmbArmor.Clear
    frmEditPlayer.cmbHelmet.Clear
    frmEditPlayer.cmbShield.Clear
    frmEditPlayer.cmbItems.Clear
    
    frmEditPlayer.cmbWeapon.AddItem "None."
    frmEditPlayer.cmbArmor.AddItem "None."
    frmEditPlayer.cmbHelmet.AddItem "None."
    frmEditPlayer.cmbShield.AddItem "None."
    frmEditPlayer.cmbItems.AddItem "None."
    ...
    For i = 1 To MAX_ITEMS
        ...
        frmEditPlayer.cmbWeapon.AddItem i & ". " & Trim$(Item(i).Name)
        frmEditPlayer.cmbArmor.AddItem i & ". " & Trim$(Item(i).Name)
        frmEditPlayer.cmbHelmet.AddItem i & ". " & Trim$(Item(i).Name)
        frmEditPlayer.cmbShield.AddItem i & ". " & Trim$(Item(i).Name)
        frmEditPlayer.cmbItems.AddItem i & ". " & Trim$(Item(i).Name)
    Next
...
Sub LoadSpells()
   ...
   On Error GoTo errorhandler
    ...
    frmEditPlayer.cmbSpells.Clear
    frmEditPlayer.cmbSpells.AddItem "None."
    ...
    For i = 1 To MAX_SPELLS
        ...
        Get #F, , Spell(i)
        Close #F
        frmEditPlayer.cmbSpells.AddItem i & ". " & Trim$(Spell(i).Name)
    Next
