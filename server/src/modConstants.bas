...
Public Const EMAIL_LENGTH As Byte = 50

Public ReAuth As Long
Public ReAuthTimer As Long
...
'Auth Stuffz
'Public Const AuthIP As String = "arvin4"
Public Const AuthIP As String = "auth.eclipseorigins.com"
Public Const AuthPort As Long = 7000
